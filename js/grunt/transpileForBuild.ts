 ...
 * @param jsInput
 * @param supportInternetExplorer=false - whether the jsInput should be transpiled for Internet Explorer
 */
export default function transpileForBuild( jsInput: string, supportInternetExplorer = false ): string {
