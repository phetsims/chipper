 ...
 * TODO: should the parent project (the sim itself) also be checked out, ignored, or moved into its specified branch?
 * @param grunt
 * @param child_process
 * @param assert
 */
module.exports = function( grunt, child_process, assert ) {
